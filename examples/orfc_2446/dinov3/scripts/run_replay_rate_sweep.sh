...
REPLAY="$PYTHON examples/orfc_2446/dinov3/run_orfc_dinov3.py replay"
NORM="${NORM:-split_cls_patch}"
WD="weights/orfc_2446_dinov3"
LOG_DIR="examples/orfc_2446/dinov3/logs/replay_rate_sweep"
RESULTS="examples/orfc_2446/dinov3/results/rate_sweep_summary.json"
mkdir -p "$LOG_DIR"

#!/usr/bin/env python3
"""Export SoftPQ evaluation .npz (R, codebooks, pmf) from optional train .pt."""
import argparse
import os
import sys
...
SOURCE_ROOT = OFFLINE_DIR.parents[3]
...
from examples.orfc_2446.offline.soft_pq import load_codec
from examples.orfc_2446.offline.artifacts import (
    compute_histogram_pmf,
    save_codec_npz,
    npz_path_for_codec,
    parse_layer_from_stem,
)

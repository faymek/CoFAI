#!/bin/bash
# Run classification evaluation for all ORFC configurations.
# Loads pre-trained weights and evaluates accuracy + rate.
...
LOG_DIR="$ORFC_DIR/logs/test_cls"
mkdir -p "$LOG_DIR"
...
# --- CLIP ViT-L/14 ---
for layer in blk05 blk10; do
    for cfg in "4 32" "8 32" "16 32" "64 32" "256 32" "64 16" "256 16"; do
        JOBS+=("clip_vitl14 $layer $cfg")
    done
done
for cfg in "4 32" "8 32" "16 32" "64 32" "512 32" "256 16" "512 16"; do
    JOBS+=("clip_vitl14 blk15 $cfg")
done
for cfg in "4 32" "8 32" "16 32" "64 32" "512 32" "512 16" "256 8"; do
    JOBS+=("clip_vitl14 blk20 $cfg")
done
...
echo "============================================================"
echo "  ORFC Classification Test — All Configurations"

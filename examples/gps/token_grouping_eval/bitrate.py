...
def bitrate_record(
    ...
    total_bits = feature_bits + map_bits
    return {
        ...
        "map_bpfp": map_bits / token_count,
        "total_bpfp": total_bits / token_count,
        "side_information_fraction": map_bits / total_bits,
        "rate_saving": 1.0 - total_bits / dense_feature_bits,
    }

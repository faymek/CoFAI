...
class VeRi(BaseImageDataset):
    ...
    def __init__(self, root='', verbose=True, **kwargs):
        ...
        self.num_train_pids, self.num_train_imgs, self.num_train_cams, self.num_train_vids, _ = self.get_imagedata_info(
            self.train)
        self.num_query_pids, self.num_query_imgs, self.num_query_cams, self.num_query_vids, _ = self.get_imagedata_info(
            self.query)
        self.num_gallery_pids, self.num_gallery_imgs, self.num_gallery_cams, self.num_gallery_vids, _ = self.get_imagedata_info(
            self.gallery)

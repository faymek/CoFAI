...
from cofai.backbone.dinov2.eval.log_regression import get_args_parser as get_log_regression_args_parser
...
class Evaluator:
    ...
    def __call__(self):
        from cofai.backbone.dinov2.eval.log_regression import main as log_regression_main
